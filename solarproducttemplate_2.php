<?php
/**
 * Template Name: Solar Lamp Product Page
 * Description: Product page template for the Solar Garden Lamp.
 */
...
$imgs = [
    'https://www.thebeamhouse.store/cdn/shop/files/1.png?v=1757951678',
    'https://www.thebeamhouse.store/cdn/shop/files/2.png?v=1757951679',
    'https://www.thebeamhouse.store/cdn/shop/files/3.png?v=1757951679',
    'https://www.thebeamhouse.store/cdn/shop/files/4.png?v=1757951678',
    'https://www.thebeamhouse.store/cdn/shop/files/5.png?v=1757951679',
    'https://www.thebeamhouse.store/cdn/shop/files/6.png?v=1757951679',
    'https://www.thebeamhouse.store/cdn/shop/files/7.png?v=1757951678',
];

$product_slug = 'solar-lamp';
$product_name = 'Solar Garden Lamp';
...
<section class="product-hero">
    ...
    <div class="product-info">
        ...
        <p class="product-description">
            Illuminate your outdoor space effortlessly with our Solar Garden Lamp.
            Powered entirely by sunlight, it charges during the day and automatically
            lights up at dusk — no wiring, no electricity bills. Perfect for pathways,
            patios, and garden beds.
        </p>

        <ul class="features-list">
            <li>Charges via solar panel — zero running costs</li>
            <li>Auto on/off with built-in light sensor</li>
            <li>IP65 weatherproof — rain, snow & heat resistant</li>
            <li>Warm white LED, up to 8–10 hours per charge</li>
            <li>Easy stake installation — no tools required</li>
...
<section class="section-features">
    <h2 class="section-title">Why Choose Our Solar Lamp?</h2>
    <div class="features-grid">
        <div class="feature-card">
            <div class="icon">☀️</div>
            <h3>Solar Powered</h3>
            <p>Harnesses sunlight for free, clean energy every single day.</p>
        </div>
        <div class="feature-card">
            <div class="icon">🌧️</div>
        ...
        <div class="feature-card">
            <div class="icon">💡</div>
            <h3>Auto Light Sensor</h3>
            <p>Turns on automatically at dusk and off at dawn — effortless.</p>
        </div>
        <div class="feature-card">
            <div class="icon">🔧</div>
            <h3>Easy Install</h3>
            <p>Push the stake into soil and you're done. No wiring needed.</p>
        </div>
        <div class="feature-card">
            <div class="icon">🌿</div>
            <h3>Zero Electricity Cost</h3>
            <p>Runs entirely on solar — save money while helping the planet.</p>
        </div>
        <div class="feature-card">
            <div class="icon">⭐</div>
            <h3>Loved by Customers</h3>
            <p>Thousands of happy gardens lit up around the world.</p>
        </div>
    </div>
</section>
    ...
    <div class="review-form-wrap">
        ...
        <form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
            ...
            <div class="form-group">
                ...
                <input type="text" id="reviewer_name" name="reviewer_name" required placeholder="e.g. Sarah M.">
            </div>
